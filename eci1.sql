...
) ENGINE=InnoDB AUTO_INCREMENT=124 DEFAULT CHARSET=utf8 COMMENT='Adminnotification Inbox';
...
insert  into `cms_block_store`(`block_id`,`store_id`) values (1,0),(2,0),(3,0);
...
insert  into `core_flag`(`flag_id`,`flag_code`,`state`,`flag_data`,`last_update`) values (1,'admin_notification_survey',0,'a:1:{s:13:\"survey_viewed\";b:1;}','2016-06-12 23:37:20');
...
insert  into `index_process`(`process_id`,`indexer_code`,`status`,`started_at`,`ended_at`,`mode`) values (1,'catalog_product_attribute','require_reindex',NULL,NULL,'real_time'),(2,'catalog_product_price','require_reindex',NULL,NULL,'real_time'),(3,'catalog_url','require_reindex','2016-06-21 22:24:08','2016-06-21 22:24:09','real_time'),(4,'catalog_product_flat','require_reindex',NULL,NULL,'real_time'),(5,'catalog_category_flat','require_reindex',NULL,NULL,'real_time'),(6,'catalog_category_product','require_reindex','2016-06-21 22:24:09','2016-06-21 22:24:09','real_time'),(7,'catalogsearch_fulltext','require_reindex','2016-06-21 22:24:09','2016-06-21 22:24:09','real_time'),(8,'cataloginventory_stock','require_reindex','2016-06-14 14:55:13','2016-06-14 14:55:13','real_time'),(9,'tag_summary','require_reindex',NULL,NULL,'real_time');
...
insert  into `permission_block`(`block_id`,`block_name`,`is_allowed`) values (1,'core/template',1),(2,'catalog/product_new',1);
