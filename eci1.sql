...
insert  into `catalog_category_entity`(`entity_id`,`entity_type_id`,`attribute_set_id`,`parent_id`,`created_at`,`updated_at`,`path`,`position`,`level`,`children_count`) values (1,3,0,0,'2016-06-12 23:34:49','2016-06-12 23:34:49','1',0,0,1),(2,3,3,1,'2016-06-12 23:34:53','2016-06-12 23:34:53','1/2',1,1,0);
...
insert  into `catalog_category_entity_text`(`value_id`,`entity_type_id`,`attribute_id`,`store_id`,`entity_id`,`value`) values (1,3,65,0,1,NULL),(2,3,65,1,1,NULL),(3,3,65,0,2,NULL),(4,3,65,1,2,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Index Event';
...
insert  into `index_process`(`process_id`,`indexer_code`,`status`,`started_at`,`ended_at`,`mode`) values (1,'catalog_product_attribute','require_reindex',NULL,NULL,'real_time'),(2,'catalog_product_price','require_reindex',NULL,NULL,'real_time'),(3,'catalog_url','require_reindex','2016-06-14 14:55:13','2016-06-14 14:55:13','real_time'),(4,'catalog_product_flat','require_reindex',NULL,NULL,'real_time'),(5,'catalog_category_flat','require_reindex',NULL,NULL,'real_time'),(6,'catalog_category_product','require_reindex','2016-06-14 14:55:13','2016-06-14 14:55:13','real_time'),(7,'catalogsearch_fulltext','require_reindex','2016-06-14 14:55:13','2016-06-14 14:55:13','real_time'),(8,'cataloginventory_stock','require_reindex','2016-06-14 14:55:13','2016-06-14 14:55:13','real_time'),(9,'tag_summary','require_reindex',NULL,NULL,'real_time');
